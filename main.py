...
DEFAULT_EVAL_DATASET_PATH = "data/2wikimqa_200_samples_from_blend_filter.json"
DEFAULT_MAX_COMPLETION_TOKENS = 20
DEFAULT_MAX_SAMPLES = 200
DEFAULT_REQUEST_BATCH_SIZE = 20
DEFAULT_ENABLE_THINKING = False
DEFAULT_DEBUG_MODE = False
DEFAULT_SAVE_RESULTS_PATH_TEMPLATE = "results/2wikimqa_200_samples_from_blend_filter/{model_name}.csv"
...
def parse_args():
    ...
    if args.save_results_path is None:
        args.save_results_path = f"results/2wikimqa_200_samples_from_blend_filter/{args.model_name}.csv"
    return args
...
async def get_response_async(client, prompt, model_name, enable_thinking, max_completion_tokens):
    ...
    if not enable_thinking:
        ...
        request_kwargs["extra_body"] = {"reasoning_effort": "none"} # for gpt and claude
